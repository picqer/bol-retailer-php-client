...
class ShipmentDetails extends AbstractModel
{
    ...
    {
        return [
            'pickupPointName' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'salutation' => [ 'model' => null, 'enum' => Enum\ShipmentDetailsSalutation::class, 'array' => false ],
            ...
            'language' => [ 'model' => null, 'enum' => Enum\ShipmentDetailsLanguage::class, 'array' => false ],
        ];
    }
    ...
    /**
     * @var Enum\ShipmentDetailsSalutation The salutation of the customer.
     */
    public $salutation;
    ...
    /**
     * @var Enum\ShipmentDetailsLanguage The language of the customer in case of contact.
     */
    public $language;
}
