...
class ReducedShipment extends AbstractModel
{
    ...
    public function getModelDefinition(): array
    {
        return [
            ...
            'order' => [ 'model' => ReducedShipmentOrder::class, 'enum' => null, 'array' => false ],
            'shipmentItems' => [ 'model' => ReducedShipmentItem::class, 'enum' => null, 'array' => true ],
            'transport' => [ 'model' => ReducedTransport::class, 'enum' => null, 'array' => false ],
        ];
    }
