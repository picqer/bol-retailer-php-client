...
class Commission extends AbstractModel
{
    ...
    public function getModelDefinition(): array
    {
        return [
            ...
            'totalCost' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'totalCostWithoutReduction' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'reductions' => [ 'model' => Reduction::class, 'enum' => null, 'array' => true ],
        ];
    }
