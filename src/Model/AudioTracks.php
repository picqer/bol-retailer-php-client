...
class AudioTracks extends AbstractModel
{
    ...
    {
        return [
            'discNumber' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'trackNumber' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'discSide' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'title' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'artistName' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'playTime' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'clipUrl' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'clipType' => [ 'model' => null, 'enum' => null, 'array' => false ],
        ];
    }
