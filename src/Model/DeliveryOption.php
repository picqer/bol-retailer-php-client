...
class DeliveryOption extends AbstractModel
{
    ...
    {
        return [
            'shippingLabelOfferId' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'recommended' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'validUntilDate' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'transporterCode' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'labelType' => [ 'model' => null, 'enum' => Enum\DeliveryOptionLabelType::class, 'array' => false ],
            'labelDisplayName' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'labelPrice' => [ 'model' => LabelPrice::class, 'enum' => null, 'array' => false ],
            'packageRestrictions' => [ 'model' => PackageRestrictions::class, 'enum' => null, 'array' => false ],
            'handoverDetails' => [ 'model' => HandoverDetails::class, 'enum' => null, 'array' => false ],
        ];
    }
    ...
    /**
     * @var Enum\DeliveryOptionLabelType The type of the label, representing the way an item is being transported.
     * MAILBOX is a mailbox package with delivery scan. MAILBOX_LIGHT is a mailbox package without delivery scan. PARCEL
     * is a normal package.
     */
    public $labelType;
