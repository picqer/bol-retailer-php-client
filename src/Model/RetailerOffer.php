...
class RetailerOffer extends AbstractModel
{
    ...
    /**
     * @var string In case the product is not known to bol.com you can use this field to identify this particular
     * product. Note: in case the product is known to bol.com, the unknown product title will not be stored.
     */
