...
class RetailerInformationResponse extends AbstractModel
{
    ...
    public function getModelDefinition(): array
    {
        return [
            ...
            'retailerRating' => [ 'model' => RetailerRating::class, 'enum' => null, 'array' => false ],
            'retailerReview' => [ 'model' => RetailerReview::class, 'enum' => null, 'array' => false ],
        ];
    }
    ...
    /**
     * @var Enum\RetailerInformationResponseRatingMethod An identifier that identifies if the rating is calculated over
     * the past three months or on all reviews for the retailer.
     */
    public $ratingMethod;
