...
class CreateReplenishmentRequest extends AbstractModel
{
    ...
    public function getModelDefinition(): array
    {
        return [
            ...
            'deliveryInfo' => [ 'model' => CreateDeliveryInfo::class, 'enum' => null, 'array' => false ],
            'labelingByBol' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'numberOfLoadCarriers' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'pickupAppointment' => [ 'model' => CreatePickupAppointment::class, 'enum' => null, 'array' => false ],
            'lines' => [ 'model' => CreateReplenishmentLine::class, 'enum' => null, 'array' => true ],
        ];
    }
