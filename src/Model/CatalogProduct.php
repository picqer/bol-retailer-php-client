...
class CatalogProduct extends AbstractModel
{
    ...
    {
        return [
            'published' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'gpc' => [ 'model' => Gpc::class, 'enum' => null, 'array' => false ],
            'enrichment' => [ 'model' => Enrichment::class, 'enum' => null, 'array' => false ],
            'attributes' => [ 'model' => Attributes::class, 'enum' => null, 'array' => true ],
            'parties' => [ 'model' => Party::class, 'enum' => null, 'array' => true ],
            'audioTracks' => [ 'model' => AudioTracks::class, 'enum' => null, 'array' => true ],
            'series' => [ 'model' => Serie::class, 'enum' => null, 'array' => true ],
        ];
    }
